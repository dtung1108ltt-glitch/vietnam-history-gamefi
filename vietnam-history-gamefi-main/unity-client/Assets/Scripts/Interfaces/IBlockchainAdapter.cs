...
namespace VnHistoryGameFi.Interfaces
{
    ...
    /// ví thật của người chơi (Sui Wallet / Phantom / ...). Vì vậy:
    ...
    ///     trị đó từ một plugin ví thật. Unity không có SDK ví Sui/Solana chính
    ///     thức tương đương @mysten/dapp-kit hay @solana/wallet-adapter phía web,
    ///     nên tự ký trong C# là không khả thi/không an toàn — implementation
    ...
    public interface IBlockchainAdapter
    {
        ...
        void ClaimReward(string wallet, int battleId,
