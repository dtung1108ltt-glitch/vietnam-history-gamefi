...
namespace VnHistoryGameFi.Core
{
    ...
    ///   - `mockArmies` vẫn giữ local (armyCatalog) vì backend chưa có domain
    ///     Army — đây là giới hạn thật của backend, không phải thiếu sót ở đây.
    /// </summary>
    public class GameManager : MonoBehaviour
    {
        ...
        // Local-only catalog: backend chưa có domain Army, xem ghi chú ở ArmyModel.cs
