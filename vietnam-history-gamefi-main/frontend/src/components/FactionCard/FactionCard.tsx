    ...
    >
      ...
      <div className="space-y-2 pt-3 border-t border-imperial-border/80">
        ...
        <div className="flex items-center justify-between text-xs">
          ...
          <span className="font-bold font-mono text-red-400">+{faction.attack_bonus}%</span>
        </div>
        <div className="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden">
          <div 
            className="bg-gradient-to-r from-red-600 to-amber-500 h-full rounded-full"
            style={{ width: `${Math.min(100, faction.attack_bonus * 2.8)}%` }}
          />
        </div>
        ...
        <div className="flex items-center justify-between text-xs mt-1.5">
          ...
          <span className="font-bold font-mono text-blue-400">+{faction.defense_bonus}%</span>
        </div>
        <div className="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden">
          <div 
            className="bg-gradient-to-r from-blue-600 to-cyan-400 h-full rounded-full"
            style={{ width: `${Math.min(100, faction.defense_bonus * 2.8)}%` }}
          />
        </div>
        ...
        <div className="flex items-center justify-between text-xs mt-1.5">
          ...
          <span className="font-bold font-mono text-amber-400">+{faction.movement_bonus}%</span>
        </div>
        <div className="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden">
          <div 
            className="bg-gradient-to-r from-amber-500 to-yellow-300 h-full rounded-full"
            style={{ width: `${Math.min(100, faction.movement_bonus * 2.8)}%` }}
          />
        </div>
      </div>
