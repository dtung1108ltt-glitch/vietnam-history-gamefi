...
export const PAYMENT_HISTORY = [
  { id: 'tx-1', type: 'Gửi', counterparty: '0x7a…c4e2', amount: '12.50 SUI', status: 'Đã xác nhận', time: '2 phút trước' },
  { id: 'tx-2', type: 'Nhận', counterparty: 'Chiến lợi phẩm', amount: '4.00 SUI', status: 'Đã xác nhận', time: '1 giờ trước' },
  { id: 'tx-3', type: 'Gửi', counterparty: 'Két tiết kiệm', amount: '20.00 SUI', status: 'Đang xác minh', time: 'Vừa xong' },
];

export const SAVINGS_VAULTS = [
  { id: 'vault-rice', name: 'Két Lúa (ổn định)', apy: '4.2%', lock: 'Rút bất kỳ lúc', tvl: '128,400 SUI', risk: 'Thấp' },
  { id: 'vault-gold', name: 'Két Vàng (kỳ hạn)', apy: '8.1%', lock: '30 ngày', tvl: '64,200 SUI', risk: 'Trung bình' },
  { id: 'vault-campaign', name: 'Két Chiến Dịch', apy: '11.5%', lock: 'Theo mùa giải', tvl: '21,080 SUI', risk: 'Cao hơn' },
];

export const LENDING_MARKETS = [
  { asset: 'SUI', supplyApy: '3.4%', borrowApy: '7.8%', ltv: '70%', liquidity: '210k' },
...
export const DEX_PAIRS = [
  { pair: 'SUI / USDC', price: '1.84', fee: '0.30%', tvl: '42,100' },
  { pair: 'GOLD / SUI', price: '0.12', fee: '0.50%', tvl: '8,640' },
  { pair: 'RICE / USDC', price: '0.41', fee: '0.30%', tvl: '6,220' },
];

export const TREASURY_FLOWS = [
  { label: 'Phí DEX', amount: '+1,240 SUI', proof: '0x9f…aa12' },
  { label: 'Lãi két tiết kiệm', amount: '+420 SUI', proof: '0x2b…7710' },
  { label: 'Thưởng chiến dịch', amount: '−880 SUI', proof: '0xc1…44de' },
  { label: 'Chi đề xuất DAO #14', amount: '−200 SUI', proof: '0x71…90ab' },
];

export const DAO_PROPOSALS = [
  { id: 14, title: 'Nạp 200 SUI vào két thưởng Bạch Đằng', status: 'Đã thông qua', forPct: 72, quorum: 40 },
  { id: 15, title: 'Giảm phí DEX cặp GOLD/SUI xuống 0.30%', status: 'Đang bỏ phiếu', forPct: 54, quorum: 40 },
